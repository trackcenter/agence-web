<template>
  <nav class="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 dark:border-gray-600 link-pers">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 navbar-pers">
      <a href="#" class="title-logo flex items-center space-x-3 rtl:space-x-reverse">
      ...
      <div class="hidden w-full md:block md:w-auto" id="navbar-dropdown">
        <ul
          ...
          <li>
            <a href="#"
              class="block py-2 px-3 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Prix</a>
          </li>
          <li>
            <a href="#"
